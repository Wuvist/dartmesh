...
(function dartProgram() {
  ...
  H = {JS_CONST: function JS_CONST() {
    ...
    _ensureNativeList: function(list) {
      ...
      if (type$.JSIndexable_dynamic._is(list))
        return list;
      result = P.List_List$filled(list.length, null, false, type$.dynamic);
  ...
  G = {
    read: function(url) {
      return G._withClient(new G.read_closure(url, null), type$.legacy_String);
    },
  ...
  E = {
    _fromUriOrString: function(uri) {
      var t1 = P.Uri_parse(uri);
      return t1;
    },
  ...
  U = {
    ...
    Highlighter$: function(span, color) {
      ...
      return new U.Highlighter(t1, t2, null, 1 + Math.max(t3.length, t4), new H.MappedListIterable(t1, t5._eval$1("int*(1)")._as(new U.Highlighter$__closure()), t5._eval$1("MappedListIterable<1,int*>")).reduce$1(0, H.instantiate1(P.math__max$closure(), type$.legacy_int)), !B.isAllTheSame(new H.MappedListIterable(t1, t5._eval$1("Object*(1)")._as(new U.Highlighter$__closure0()), t5._eval$1("MappedListIterable<1,Object*>"))), new P.StringBuffer(""));
    },
  ...
  var holders = [C, H, J, P, W, M, B, G, E, T, O, Z, U, X, R, N, F, L, Y, V, D, S];
  ...
  E.BaseClient.prototype = {
    read$2$headers: function(url, headers) {
      return this.read$body$BaseClient(url, type$.legacy_Map_of_legacy_String_and_legacy_String._as(headers));
    },
    read$body$BaseClient: function(url, headers) {
      var $async$goto = 0,
        $async$completer = P._makeAsyncAwaitCompleter(type$.legacy_String),
        ...
        while (true)
          switch ($async$goto) {
            case 0:
              // Function start
              $async$goto = 3;
              return P._asyncAwait($async$self._sendUnstreamed$3("GET", url, type$.legacy_Map_of_legacy_String_and_legacy_String._as(headers)), $async$read$2$headers);
            case 3:
              // returning from await.
    ...
    _sendUnstreamed$3: function(method, url, headers) {
      return this._sendUnstreamed$body$BaseClient(method, url, type$.legacy_Map_of_legacy_String_and_legacy_String._as(headers));
    },
    ...
    _checkResponseSuccess$2: function(url, response) {
      ...
      if (t1 < 400)
        return;
      message = "Request to " + url + " failed with status " + t1;
      t1 = response.reasonPhrase;
      throw H.wrapException(E.ClientException$((t1 != null ? message + ": " + t1 : message) + ".", E._fromUriOrString(url)));
    },
    $isClient: 1
  };
  ...
  O.BrowserClient.prototype = {
    ...
    close$0: function() {
      for (var t1 = this._xhrs, t1 = P._LinkedHashSetIterator$(t1, t1._modifications, t1.$ti._precomputed1); t1.moveNext$0();)
  ...
  M.Context.prototype = {
    absolute$1: function(_, part1) {
      var t1, _null = null;
      M._validateArgList("absolute", H.setRuntimeTypeInfo([part1, null, null, null, null, null, null], type$.JSArray_legacy_String));
      t1 = this.style;
  ...
  U.Highlighter.prototype = {
    highlight$0: function() {
      var t2, highlightsByColumn, t3, t4, i, line, lastLine, t5, t6, t7, t8, t9, cur, t10, index, primary, _i, _this = this,
        t1 = _this._lines;
      ...
      for (t2 = _this._buffer, t3 = highlightsByColumn.length !== 0, t4 = _this._primaryColor, i = 0; i < t1.length; ++i) {
        ...
        for (t5 = line.highlights, t6 = H._arrayInstanceType(t5)._eval$1("ReversedListIterable<1>"), t7 = new H.ReversedListIterable(t5, t6), t6 = new H.ListIterator(t7, t7.get$length(t7), t6._eval$1("ListIterator<ListIterable.E>")), t7 = line.number, t8 = line.text, t9 = J.getInterceptor$s(t8); t6.moveNext$0();) {
          ...
          t10 = cur.span;
          if (t10.get$start().get$line() != t10.get$end().get$line() && t10.get$start().get$line() === t7 && _this._isOnlyWhitespace$1(t9.substring$2(t8, 0, t10.get$start().get$column()))) {
  ...
  U.Highlighter__collateLines_closure1.prototype = {
    call$1: function(highlightsForFile) {
      ...
      for (t1 = J.getInterceptor$ax(highlightsForFile), t2 = t1.get$iterator(highlightsForFile), t3 = type$.JSArray_legacy__Highlight; t2.moveNext$0();) {
        ...
        t5 = C.JSString_methods.allMatches$1("\n", C.JSString_methods.substring$2(context, 0, B.findLineStart(context, t4.get$text(t4), t4.get$start().get$column())));
  ...
  U._Highlight_closure.prototype = {
    call$0: function() {
      var t2, t3, t4, t5,
        t1 = this.span;
      if (!(type$.legacy_SourceSpanWithContext._is(t1) && B.findLineStart(t1.get$context(), t1.get$text(t1), t1.get$start().get$column()) != null)) {
        t2 = t1.get$start();
  ...
  (function installTearOffs() {
    ...
    _instance(P._Completer.prototype, "get$completeError", 0, 1, function() {
      return [null];
    }, ["call$2", "call$1"], ["completeError$2", "completeError$1"], 39, 0);
    _instance_2_u(P._Future.prototype, "get$_completeError", "_completeError$2", 40);
  ...
  (function inheritance() {
    ...
    _inheritMany(J.JavaScriptObject, [J.PlainJavaScriptObject, J.UnknownJavaScriptObject, J.JavaScriptFunction, S.Promise]);
    ...
    _inheritMany(P.Iterable, [H.EfficientLengthIterable, H.MappedIterable, H.WhereIterable, H.ExpandIterable, H.SkipIterable, P.IterableBase, H._StringAllMatchesIterable]);
    ...
    _inheritMany(P.Codec, [P.Encoding, P.Base64Codec]);
    _inheritMany(P.Encoding, [P.AsciiCodec, P.Latin1Codec, P.Utf8Codec]);
    _inherit(P.Converter, P.StreamTransformerBase);
    _inheritMany(P.Converter, [P._UnicodeSubsetDecoder, P.Base64Encoder, P.Utf8Decoder]);
  ...
  var type$ = (function rtii() {
    ...
    return {
      ...
      legacy_void_Function_2_legacy_void_Function_legacy_String_and_legacy_Function: findType("~(~(String*)*,Function*)*"),
